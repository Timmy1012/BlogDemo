...
class ArticleModelTest(TestCase):
    def setUp(self):
        ...
        self.article = Article.objects.create(title=self.article_title, content=self.article_content)
...
class ArticleAPITest(TestCase):
    ...
    def test_edit_article(self):
        ...
        updated_article_data = {"title": "Updated Title", "content": "Updated content."}
        ...
        self.assertEqual(
            response.json().get("title"),
            updated_article_data["title"],
            "Article title was not updated",
        )
        self.assertEqual(
            response.json().get("content"),
            updated_article_data["content"],
            "Article content was not updated",
        )
